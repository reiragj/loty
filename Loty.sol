...
contract Loty is StandardToken, OwnableToken {
    using SafeMath for uint256;

    // Token Distribution Rate
    uint256 public constant SUM = 20000000000;   // totalSupply
    uint256 public constant DISTRIBUTION = 12600000000; // distribution
    uint256 public constant DEVELOPERS =    7400000000;   // developer

    // Token Information
    string public constant name = "Lonate";
